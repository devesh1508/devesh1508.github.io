...
**From Contact to Cognition**: I believe robots exist in a physical world where they have to do more than seeing and reacting. I believe true autonomy would come by reasoning about making and breaking contacts. My research develops **physical intelligence for robotic manipulation**: contact-rich and dexterous manipulation, tactile sensing, contact-implicit trajectory optimization, learning from demonstration, and foundation models for robotics. I have published 80+ papers at venues like ICRA, IROS, RSS, CoRL, T-RO, NeurIPS and ICML, and hold 20 granted or allowed patents.
